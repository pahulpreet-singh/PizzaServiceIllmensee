...
/**
 * Created by multani on 05/02/17.
 */

//Recycler View's touch listener
...
public class RecyclerViewClickSupport {
    ...
    public static RecyclerViewClickSupport addTo(RecyclerView view) {
        RecyclerViewClickSupport support = (RecyclerViewClickSupport) view.getTag(R.id.item_click_support);
        if (support == null) {
