...
public class TheCart2 extends AppCompatActivity {
    RecyclerView rview;
    Button proceed;
    String FILE;
    TextView totalPrice;
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(AddToCartHelper.flagAddToCart)
                    ...
                    Toast.makeText(TheCart2.this, "Einkaufswagen ist leer", Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void initComponents() {
        ...
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(TheCart2.this);
        rview.setLayoutManager(mLayoutManager);
        rview.addItemDecoration(new DividerItemDecoration(this, LinearLayoutManager.VERTICAL));
        rview.setAdapter(new CustomAdapterTc(TheCart2.this));
    ...
    class CustomAdapterTc extends RecyclerView.Adapter<CustomAdapterTc.ViewHolder>
    {
        ...
        public void onBindViewHolder(CustomAdapterTc.ViewHolder holder, final int position) {
            ...
            holder.remove.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(TheCart2.this);
    ...
    class CreatePDF extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(TheCart2.this,"Schicke Nachricht",
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(TheCart2.this,"Nachricht gesendet",Toast.LENGTH_LONG).show();
        }
